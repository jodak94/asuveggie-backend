...
@section('content-header')
    <h1>
        {{ trans('publicidades::publicidads.title.edit publicidad') }}
    </h1>
    <ol class="breadcrumb">
        ...
        <li class="active">{{ trans('publicidades::publicidads.title.edit publicidad') }}</li>
    </ol>
@stop
@push('css-stack')
...
@endpush
@section('content')
    {!! Form::open(['route' => ['admin.publicidades.publicidad.update', $publicidad->id], 'method' => 'put', 'id' => 'form']) !!}
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="tab-content">
                    ...
                    @foreach (LaravelLocalization::getSupportedLocales() as $locale => $language)
                        ...
                        <div class="tab-pane {{ locale() == $locale ? 'active' : '' }}" id="tab_{{ $i }}">
                            @include('publicidades::admin.publicidads.partials.edit-fields', ['lang' => $locale])
                        </div>
                    @endforeach
